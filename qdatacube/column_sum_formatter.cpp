   ...
   m_suffix(suffix)
{
  ...
  QString big_cell_contents = QString::number(accumulator*scale, 'f', precision) + suffix;
  set_cell_size(QSize(view->fontMetrics().width(big_cell_contents), view->fontMetrics().lineSpacing()));
